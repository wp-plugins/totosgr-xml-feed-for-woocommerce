...
class donations extends panel
{
    ...
    public function __construct($instance, $menu_page)
    {
        ...
        $this->content_body
          = // Donations (form field selection).
          ...
          $form_fields->markup(
            $form_fields->¤value('_s-xclick'), array(
            'type' => 'hidden',
            'name' => 'cmd'
          )
          ).
          $form_fields->markup(
            $form_fields->¤value('WLGJ8L3ZJTFQQ'), array(
            'type' => 'hidden',
            'name' => 'hosted_button_id'
          )
          ).
          $form_fields->markup(
            $form_fields->¤value('Your site URL'), array(
            'type' => 'hidden',
            'name' => 'on1'
          )
          ).
          ...
          $form_fields->markup(
            $form_fields->¤value($this->©urls->to_wp_home_uri()), array(
            'type' => 'text',
            'name' => 'os1'
          )
          ).
