...
namespace xd_v141226_dev {
    ...
    final class builder extends framework
    {
        ...
        public function __construct(
          $instance, $plugin_dir = '', $plugin_name = '', $plugin_root_ns = '', $distros_dir = '', $downloads_dir = '',
        ...
        protected function build()
        {
            ...
            $successes->add(
              $this->method(__FUNCTION__).'#starting_branch_core', get_defined_vars(),
              sprintf(
                $this->__('Building from %1$s branch: `%2$s` (version: `%3$s`) w/ class file: `%4$s`.'),
            ...
            if ($this->plugin_dir) // Building a plugin.
            {
                ...
                $this->©command->git(
                  'commit --all --allow-empty --message '. // Restore point (before building).
                  escapeshellarg($this->__('Auto-commit; before building plugin.')), $this->plugin_repo_dir
                );

                $successes->add(
                  $this->method(__FUNCTION__).'#before_building_plugin', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#new_branch_before_building_plugin', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#new_core_dir_replication_into_plugin_dir', get_defined_vars(),
                ...
                if ($this->use_core_type !== 'directory') {
                    unset($_new_core_dir);
                } // Housekeeping.
                ...
                if ($this->use_core_type !== 'submodule') // XDaRk Core stub file?
                {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_stub_added_to_plugin_dir', get_defined_vars(),
                ...
                if ($this->use_core_type === 'phar') // Bundle XDaRk Core PHP archive (e.g. the PHAR file)?
                {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_phar_added_to_plugin_dir', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#plugin_file_updates', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#plugin_distro_files', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#plugin_distro_dir_checksum', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#plugin_distro_zips', get_defined_vars(),
                ...
                if ($this->use_core_type === 'directory' && isset($_new_core_dir)) {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_dir_deletion', get_defined_vars(),
                ...
                if ($this->use_core_type === 'phar' && isset($_new_core_phar)) {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_phar_deletion', get_defined_vars(),
                ...
                if ($this->plugin_pro_dir) // Is there a pro directory also?
                {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#before_building_plugin_pro', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_branch_before_building_plugin_pro', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_dir_replication_into_plugin_pro_dir', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_pro_file_updates', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_pro_distro_files', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_pro_distro_dir_checksum', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_pro_distro_zips', get_defined_vars(),
                    ...
                    $this->©command->git('add --all', $this->plugin_pro_repo_dir);
                    $this->©command->git(
                      'commit --all --allow-empty --message '. // Final commit (after building).
                    ...
                    if ($this->©string->is_plugin_stable_version($this->version)) {
                        $this->©command->git(
                          'tag --message '. // Tag this commit (after building).
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#commit_after_building_plugin_pro', get_defined_vars(),
                ...
                if ($this->plugin_extras_dir) // Is there an extras directory also?
                {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_dir_replication_into_plugin_extras_dir', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_extra_file_updates', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_extras_distro_files', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#plugin_extras_distro_zips', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#commit_before_plugin_build_complete', get_defined_vars(),
            ...
            else // We will either build a new XDaRk Core (or rebuild this one).
            {
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#before_building_'.$new_slug.'core', get_defined_vars(),
                ...
                if ($is_new) // Replicate XDaRk Core into a new directory.
                {
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#branch_new_core_dir', get_defined_vars(),
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#new_core_dir_replication', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#'.$new_slug.'core_file_updates', get_defined_vars(),
                ...
                $this->©dir->phar_to(
                  $_this_core_distro_temp_dir, $_this_core_phar,
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#'.$new_slug.'core_phar_built_for_'.$new_slug.'core_distro_temp_dir', get_defined_vars(),
                ...
                { // Be sure all of these classes are loaded up into memory (to avoid autoload issues).
                    ...
                    $successes->add(
                      $this->method(__FUNCTION__).'#after_new_core_dir', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#commit_before_'.$new_slug.'core_build_complete', get_defined_vars(),
                ...
                $successes->add(
                  $this->method(__FUNCTION__).'#'.$new_slug.'core_build_complete',
                  get_defined_vars(), sprintf($this->__('%1$s %2$s complete!'), $ucfirst_core, $build)
                );
            }
            $successes->add(
              $this->method(__FUNCTION__).'#finish_time', get_defined_vars(),
            ...
            switch ($pattern_name) // Handle this pattern (by name).
            {
                ...
                case 'plugin_readme__wp_version_stable_tag':
                    $string = preg_replace_callback(
                      $pattern, function ($m) use ($_this, $value) {
