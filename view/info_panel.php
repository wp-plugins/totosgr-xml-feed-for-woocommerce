...
/* @var \totos\menu_pages\panels\info $callee */
...
if (empty($info)) {
    ...
    <div class="alert alert-success" role="alert">
        <p>
            <?php echo $this->__('Give the following path to totos.gr:'); ?>
        </p>
        <p>
            <strong><?php echo $this->©totos->getGenerateXmlUrl(); ?></strong>
        </p>
    </div>
    ...
    <ul class="list-group">
        ...
        echo '<a class="pull-right btn btn-primary btn-sm copy-gen-url" href="'.$this->©totos->getGenerateXmlUrl().'" target="_blank" role="button">Open Generate URL</a>';
        echo '</li>';
        ?>
    </ul>
...
<script>
    (function ($)
    {
        ...
        $('.getGenUrl').click(function (e)
        {
            ...
            $totos.$ajax.copyToClipboard('<?php echo get_home_url(); ?>' + '?' + $('#xml-generate-var').val() + '=' + $('#xml-generate-var-val').val());
        });
    })(jQuery);
</script>
